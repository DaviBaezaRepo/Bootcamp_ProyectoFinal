...
function Events({ numberOfEvents }: { numberOfEvents: number }) { 
    const [selectedEvent, setSelectedEvent] = useState<any>(null); // State to hold selected event
    ...
    const posts = [
        ...
        },
        {
            ...
            authorLogo: "https://randomuser.me/api/portraits/women/46.jpg",
    ...
    // Handle click event on event card
            ...
            <div className="mt-12 grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                {
                    ...
                    filteredEvents.map((item, key) => (
                        <article className="transform transition duration-300 hover:scale-105 max-w-md mx-auto mt-4 border rounded-md" key={key} onClick={() => handleEventClick(item)}>
                            <a href={item.href}>
                                ...
                                <div className="pt-3 ml-4 mr-2 mb-3">
                                    ...
                                    <p className="text-gray-400 text-sm mt-1 font-normal description">{item.desc}</p>
                                </div>
                            </a>
                        </article>
                    ))
