    ...
    return (
        <footer className="text-gray-500 bg-white px-4 py-5 mx-auto md:px-8 mt-14 bg-green">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <img src="../src/assets/better-world-negative-logo2.png" className="w-32 sm:mx-auto" />
            ...
            <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
                {
                    footerNavs.map((item, idx) => (
                        <li>
                            <a key={idx} href={item.href} className="hover:text-lime-100">
                                { item.name }
                            </a>
                        </li>
                    ))
                    ...
                    <ul className="flex items-center space-x-4">
                        <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <a href="javascript:void()">
                                <svg className="svg-icon w-6 h-6 text-white" viewBox="0 0 20 20">
